			...
			<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php if ( ( 'off' !== $show_default_title && $is_page_builder_used ) || ! $is_page_builder_used ) { ?>
						...
						<?php
							if ( ! post_password_required() ) :
								...
								et_divi_post_meta();
								echo get_the_term_list( $post->ID, 'job_category', '<b>Job Category: </b>', ', ', '');
				...
				<?php  } ?>
					...
					<?php	do_action( 'et_before_content' );
						...
						the_content();
					?>
						<div class="job-apply"><a class="et_pb_button" href="<?php site_url();?>/job-application/?job_id=<?php echo $post->post_name; ?>">Apply Now</a></div>
					<?php
